...
### Number of Protests in Portuguese Speaking Africa

```{r protests-per-year-portuguese-speaking-countries}
d <- protests
d %>% 
...
ggplot( aes(x = eyr, y = n, color = countryname)) + 
  geom_point(alpha = .2) + 
  geom_smooth(se=F) +
  labs(x = "Year", y = "Number of Protest Events", title = "Protests in Portuguese-Speaking Africa")
