...
Much of the literature on women and land tenure has focused of questions surrounding customary land systems and whether they provide greater protections for women. A dominant view in the literature and among policymakers is that land reform should build on customary land systems and existing instituions rather than break with them. These arguments are based on evidence that land titiling and registration programs and the erosion of custormary systems during and after independence were a setback for women. However, a growing number of feminist scholars and African women's rights activists have challenged the claim that reforming customary systems advances women's land interets. This view argues that only right-based land systems and formal property rights will enable women to break from the patriarchal power structures of customary land systems. Using data for 16 countries in Sub-Saharan Africa, I investigate how formal property rights impact women's tenure security in Sub-Saharan Africa. 
...
landata <- read_csv("data/Africa_SIGI2019.csv") 
...
# Ploting Women's Tenure Security in Africa 
...
# Ploting Property Rights in Africa
...
## Model 1 - OLS Regression (SIGI 2019 Data)

```{r regression}

# adding data for IV's
corruptiondata <- read_csv("data/Sub-Saharan-Africa_corruption.csv") 
names(corruptiondata) <- corruptiondata[1, ] 
